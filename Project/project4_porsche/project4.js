...
$(".toggle_box span").on("click", () => {
  ...
  $("#project4").toggleClass("dark_mode");
  $("#project4").children(".title").toggleClass("dark_mode");
  $(".container").children(".porsche").children("h1").toggleClass("dark_mode");
  $(".porsche").children("ul").children("li").toggleClass("dark_mode");
